...
void pread_callback(WFFileIOTask *fileIOTask) {
    FileIOArgs *args = fileIOTask->get_args();
    long ret = fileIOTask->get_retval();
    HttpResponse *resp = (HttpResponse *)fileIOTask->user_data;
...
int main(int argc, char *argv[]) {
    ...
    auto &&server_proc = std::bind(server_process, std::placeholders::_1, root);
